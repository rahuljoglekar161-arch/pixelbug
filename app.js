...
function getInvoicePrintStyles() {
  return `
    ...
    * { box-sizing: border-box; }
    ...
    .invoice-print-page { width: 210mm; min-height: 297mm; margin: 0 auto; background: #fff; padding: 6.5mm 7mm; font-size: 11px; line-height: 1.28; box-shadow: none; break-after: page; page-break-after: always; }
    ...
    .invoice-print-brand-title { margin: 0 0 3px; font-family: "Space Grotesk", sans-serif; font-size: 21px; font-weight: 700; line-height: 1.04; }
    .invoice-print-company-line { margin: 0 0 1px; color: #4a5b6d; font-size: 9px; line-height: 1.18; }
    .invoice-print-copy-block { margin-left: auto; text-align: right; }
    .invoice-print-document-title { font-family: "Space Grotesk", sans-serif; font-size: 23px; font-weight: 700; line-height: 1.04; text-align: right; white-space: nowrap; }
    .invoice-print-copy-label { margin-top: 3px; color: #5c6b7a; font-size: 9px; font-weight: 700; letter-spacing: .08em; text-transform: uppercase; text-align: right; }
    .invoice-print-subtle { color: #667789; font-size: 9px; line-height: 1.24; white-space: pre-line; }
    ...
    .invoice-print-meta span { color: #667789; font-size: 10px; }
    ...
    .invoice-print-grid h2 { margin: 0 0 3px; font-size: 9px; text-transform: uppercase; letter-spacing: .08em; color: #5c6b7a; }
    ...
    .invoice-print-billto h2 { margin: 0 0 2px; color: #5c6b7a; font-size: 9px; letter-spacing: .08em; text-transform: uppercase; }
    ...
    .invoice-print-detail-list span { color: #667789; font-size: 9px; }
    ...
    .invoice-print-table th { color: #5c6b7a; font-size: 8.5px; text-transform: uppercase; letter-spacing: .08em; background: #f8fafc; }
    ...
    .invoice-print-hsn-summary h2 { margin: 0 0 3px; color: #5c6b7a; font-size: 9px; letter-spacing: .08em; text-transform: uppercase; }
    ...
    .invoice-print-hsn-summary-table th { color: #5c6b7a; font-size: 8.5px; text-transform: uppercase; letter-spacing: .08em; background: #f8fafc; }
    ...
    .invoice-print-total-row { font-size: 11.5px; font-weight: 700; }
    .invoice-print-total-row strong { font-size: 12px; }
    .invoice-print-totals > div:not(.invoice-print-amount-words):not(.invoice-print-signature) > span { color: #667789; font-size: 9.5px; }
    ...
    .invoice-print-amount-line span { display: block; margin-bottom: 2px; color: #5c6b7a; font-size: 8.5px; letter-spacing: .08em; text-transform: uppercase; }
    .invoice-print-amount-line strong { display: block; color: #17212b; font-size: 10px; font-style: italic; line-height: 1.24; }
    .invoice-print-bank-block { margin-top: 5px; color: #4a5b6d; font-size: 9px; line-height: 1.24; }
    ...
    .invoice-print-balance { border-top: 2px solid #dfe6ef; border-bottom: 1px solid #dfe6ef; padding-top: 4px; font-size: 12px; }
    ...
    .invoice-print-signature strong { display: block; margin-bottom: 2px; color: #17212b; font-size: 9.5px; white-space: nowrap; }
    .invoice-print-signature span { color: #17212b; font-size: 9.5px; font-weight: 700; }
    .invoice-print-footer { margin-top: 6px; border-top: 1px solid #dfe6ef; padding-top: 4px; color: #667789; font-size: 8.5px; line-height: 1.22; }
    .invoice-print-thank-you { margin-bottom: 2px; color: #17212b; font-weight: 700; }
    .invoice-print-payment-note { font-size: 8.5px; line-height: 1.22; }
